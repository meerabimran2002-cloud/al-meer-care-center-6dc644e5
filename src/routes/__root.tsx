  ...
  head: () => ({
    meta: [
      ...
      { title: "Al Meer Hospital — Premium Care, Modern Medicine" },
      {
        name: "description",
        content:
          "Al Meer Hospital delivers world-class, patient-first care with leading specialists, advanced diagnostics, and 24/7 emergency services.",
      },
      { name: "author", content: "Al Meer Hospital" },
      { property: "og:title", content: "Al Meer Hospital — Premium Care, Modern Medicine" },
      {
